...
export const BKI_SMC_CHECKLIST_TEMPLATE = [
  ...
  { id: 'chk-1.2.8', no: '1.2.8', section: '1. TINJAUAN FISIK KAPAL & PERSYARATAN UMUM', subsection: '1.2 Ruang Akomodasi Awak Kapal', item: 'Apakah ruang perawatan kesehatan kapal (hospital room) siap digunakan untuk keadaan darurat medis?', ismCode: '1.2', defaultResult: '', remark: '', isStrikethrough: false },
  { id: 'chk-1.2.9', no: '1.2.9', section: '1. TINJAUAN FISIK KAPAL & PERSYARATAN UMUM', subsection: '1.2 Ruang Akomodasi Awak Kapal', item: 'Apakah obat-obatan dan persediaan medis di atas kapal dikontrol dan dikelola dengan baik?', ismCode: '1.2', defaultResult: '', remark: '', isStrikethrough: false },
  ...
  { id: 'chk-1.4.1', no: '1.4.1', section: '1. TINJAUAN FISIK KAPAL & PERSYARATAN UMUM', subsection: '1.4 Wawancara Awak Kapal / ABK', item: 'Wawancara dengan Awak Kapal (Geladak: Juru Mudi, Mesin: Juru Minyak, Katering: Koki) terkait tanggal naik kapal dan pelaksanaan familiarisasi', ismCode: '6.3', defaultResult: '', remark: '', isStrikethrough: false },
  ...
  { id: 'chk-1.4.8', no: '1.4.8', section: '1. TINJAUAN FISIK KAPAL & PERSYARATAN UMUM', subsection: '1.4 Wawancara Awak Kapal / ABK', item: 'Apakah awak kapal mengetahui lokasi dan cara pengoperasian alat-alat keselamatan (sekoci, liferaft, pelampung penolong) serta tata cara peluncurannya?', ismCode: '8.2', defaultResult: '', remark: '', isStrikethrough: false },

  // 1.6 Tinjauan Fisik Khusus Tipe Kapal (Bagian A s/d E pada Formulir BKI F23.14.06-2024 Rev 05)
  { id: 'chk-1.6.1', no: '1.6.1', section: '1. TINJAUAN FISIK KAPAL & PERSYARATAN UMUM', subsection: '1.6 Tinjauan Fisik Khusus Tipe Kapal', item: 'Apakah terdapat fasilitas akomodasi awak kapal yang rusak atau tidak berfungsi? (Toilet umum, shower & toilet kabin)', ismCode: '', defaultResult: '', remark: '', isStrikethrough: false },
  { id: 'chk-1.6.2', no: '1.6.2', section: '1. TINJAUAN FISIK KAPAL & PERSYARATAN UMUM', subsection: '1.6 Tinjauan Fisik Khusus Tipe Kapal', item: 'Apakah Sijil Keadaan Darurat yang terpasang telah diperbarui? (Kamar Mesin, Akomodasi, Anjungan)', ismCode: '8.2', defaultResult: '', remark: '', isStrikethrough: false },
  { id: 'chk-1.6.3', no: '1.6.3', section: '1. TINJAUAN FISIK KAPAL & PERSYARATAN UMUM', subsection: '1.6 Tinjauan Fisik Khusus Tipe Kapal', item: 'Apakah buku petunjuk pelatihan SOLAS dikontrol dengan baik? (Mess Room, Ruang Rekreasi)', ismCode: '8.2', defaultResult: '', remark: '', isStrikethrough: false },
  { id: 'chk-1.6.4', no: '1.6.4', section: '1. TINJAUAN FISIK KAPAL & PERSYARATAN UMUM', subsection: '1.6 Tinjauan Fisik Khusus Tipe Kapal', item: 'Apakah ruang perawatan medis / rumah sakit kapal siap untuk penggunaan darurat?', ismCode: '1.2', defaultResult: '', remark: '', isStrikethrough: false },
  { id: 'chk-1.6.5', no: '1.6.5', section: '1. TINJAUAN FISIK KAPAL & PERSYARATAN UMUM', subsection: '1.6 Tinjauan Fisik Khusus Tipe Kapal', item: 'Apakah peralatan penutup bukaan, alat penolong (LSA), dan alat pemadam kebakaran (FFA) dirawat dengan baik? (Sekoci, Fire Damper)', ismCode: '10', defaultResult: '', remark: '', isStrikethrough: false },
  { id: 'chk-1.6.6', no: '1.6.6', section: '1. TINJAUAN FISIK KAPAL & PERSYARATAN UMUM', subsection: '1.6 Tinjauan Fisik Khusus Tipe Kapal', item: 'Apakah terdapat permesinan dan peralatan bantu yang tidak beroperasi? (Mesin Kemudi, OWS, Sewage Plant, Generator, Pompa Pemadam)', ismCode: '10.2', defaultResult: '', remark: '', isStrikethrough: false },
  { id: 'chk-1.6.7', no: '1.6.7', section: '1. TINJAUAN FISIK KAPAL & PERSYARATAN UMUM', subsection: '1.6 Tinjauan Fisik Khusus Tipe Kapal', item: 'Apakah petunjuk pengoperasian pergantian kemudi darurat terpasang di ruang kemudi?', ismCode: '8.2', defaultResult: '', remark: '', isStrikethrough: false },
  { id: 'chk-1.6.8', no: '1.6.8', section: '1. TINJAUAN FISIK KAPAL & PERSYARATAN UMUM', subsection: '1.6 Tinjauan Fisik Khusus Tipe Kapal', item: 'Apakah kapal diawaki sesuai Surat Ukur Pengawakan Aman (Safe Manning) dan sertifikat para perwira/awak kapal masih berlaku?', ismCode: '6.2.2', defaultResult: '', remark: '', isStrikethrough: false },
  { id: 'chk-1.6.9', no: '1.6.9', section: '1. TINJAUAN FISIK KAPAL & PERSYARATAN UMUM', subsection: '1.6 Tinjauan Fisik Khusus Tipe Kapal', item: 'Apakah pengisian buku jurnal (Oil Record Book, Garbage Record Book, Cargo Record Book) tercatat secara lengkap dan benar?', ismCode: '7', defaultResult: '', remark: '', isStrikethrough: false },
  { id: 'chk-1.6.10', no: '1.6.10', section: '1. TINJAUAN FISIK KAPAL & PERSYARATAN UMUM', subsection: '1.6 Tinjauan Fisik Khusus Tipe Kapal', item: 'Apakah Manual Pengikatan Muatan (Cargo Securing Manual) / Buku Register Alat Bongkar Muat dan catatan bilga palka terpelihara serta valid?', ismCode: '10', defaultResult: '', remark: '', isStrikethrough: false },

  // 1.5 Wawancara Nakhoda (Master Interview)
  { id: 'chk-1.5.2', no: '1.5.2', section: '1. TINJAUAN FISIK KAPAL & PERSYARATAN UMUM', subsection: '1.5 Wawancara Nakhoda (Master)', item: 'Apakah masa berlaku sertifikat statutori kapal dilaporkan ke kantor manajemen perusahaan sesuai prosedur?', ismCode: '10.1', defaultResult: '', remark: '', isStrikethrough: false },
  ...
  { id: 'chk-1.5.5', no: '1.5.5', section: '1. TINJAUAN FISIK KAPAL & PERSYARATAN UMUM', subsection: '1.5 Wawancara Nakhoda (Master)', item: 'Apakah seluruh pelaut dan awak kapal memegang sertifikat kesehatan pelaut (medical certificate) yang masih berlaku?', ismCode: '1.2.3.1', defaultResult: '', remark: '', isStrikethrough: false },
  ...
  { id: 'chk-1.5.7', no: '1.5.7', section: '1. TINJAUAN FISIK KAPAL & PERSYARATAN UMUM', subsection: '1.5 Wawancara Nakhoda (Master)', item: 'Apakah jumlah pengawakan kapal memenuhi ketentuan Dokumen Pengawakan Aman (Safe Manning Certificate)?', ismCode: '6.2.2', defaultResult: '', remark: '', isStrikethrough: false },
  { id: 'chk-1.5.15', no: '1.5.15', section: '1. TINJAUAN FISIK KAPAL & PERSYARATAN UMUM', subsection: '1.5 Wawancara Nakhoda (Master)', item: 'Apakah catatan harian kapal (log-book) diisi sesuai persyaratan konvensi SOLAS dan SMS Perusahaan?', ismCode: '8.2', defaultResult: '', remark: '', isStrikethrough: false },
  { id: 'chk-1.5.17', no: '1.5.17', section: '1. TINJAUAN FISIK KAPAL & PERSYARATAN UMUM', subsection: '1.5 Wawancara Nakhoda (Master)', item: 'Apakah pencatatan pada Buku Catatan Minyak (Oil Record Book) dan Buku Catatan Sampah diisi secara tertib dan mutakhir?', ismCode: '7', defaultResult: '', remark: '', isStrikethrough: false },
  { id: 'chk-1.5.21', no: '1.5.21', section: '1. TINJAUAN FISIK KAPAL & PERSYARATAN UMUM', subsection: '1.5 Wawancara Nakhoda (Master)', item: 'Kepatuhan terhadap regulasi Flag State: Manajemen Keamanan Siber Kapal (SE 35/2020) & Protokol Kesehatan (SE 14/2020)', ismCode: '1.2.3.1', defaultResult: '', remark: '', isStrikethrough: false },

  // 2. KEBIJAKAN KESELAMATAN & PERLINDUNGAN LINGKUNGAN
  { id: 'chk-2.1', no: '2.1', section: '2. KEBIJAKAN KESELAMATAN & PERLINDUNGAN LINGKUNGAN', subsection: '2. Kebijakan K3L', item: 'Apakah Kebijakan Keselamatan dan Perlindungan Lingkungan tersedia, dipahami awak kapal, dan diimplementasikan secara konsisten?', ismCode: '2', defaultResult: '', remark: '', isStrikethrough: false },

  // 3. TANGGUNG JAWAB & WEWENANG PERUSAHAAN
  { id: 'chk-3.1', no: '3.1', section: '3. TANGGUNG JAWAB & WEWENANG PERUSAHAAN', subsection: '3. Tanggung Jawab', item: 'Apakah nama Perusahaan yang tertera pada sertifikat DOC identik dengan entitas yang dilaporkan dan tanggung jawabnya telah ditentukan?', ismCode: '3', defaultResult: '', remark: '', isStrikethrough: false },

  // 4. PERSONEL YANG DITUNJUK DI DARAT (DPA)
  { id: 'chk-4.1', no: '4.1', section: '4. PERSONEL YANG DITUNJUK DI DARAT (DPA)', subsection: '4. DPA', item: 'Apakah kegiatan pemantauan oleh DPA terkait aspek keselamatan dan pencegahan pencemaran memadai serta perannya diketahui Nakhoda?', ismCode: '4', defaultResult: '', remark: '', isStrikethrough: false },

  // 5. TANGGUNG JAWAB & WEWENANG NAKHODA
  { id: 'chk-5.1', no: '5.1', section: "5. TANGGUNG JAWAB & WEWENANG NAKHODA", subsection: '5. Tanggung Jawab', item: 'Apakah Nakhoda memahami tanggung jawab dan wewenang mutlaknya (overriding authority) sesuai ketentuan Bagian 5 ISM Code?', ismCode: '5.2', defaultResult: '', remark: '', isStrikethrough: false },
  { id: 'chk-5.6', no: '5.6', section: "5. TANGGUNG JAWAB & WEWENANG NAKHODA", subsection: '5. Tinjauan SMS', item: 'Apakah Nakhoda telah melakukan peninjauan kembali (review) implementasi SMS dan melaporkan kekurangannya kepada manajemen darat?', ismCode: '5.1.5', defaultResult: '', remark: '', isStrikethrough: false },
  ...
  // 6. SUMBER DAYA & AWAK KAPAL (CREWING)
  { id: 'chk-6.1', no: '6.1', section: '6. SUMBER DAYA & AWAK KAPAL (CREWING)', subsection: '6. Awak Kapal', item: 'Apakah bahasa kerja resmi yang ditentukan oleh perusahaan dicatat di dalam buku harian kapal (Bahasa Indonesia)?', ismCode: '6.6', defaultResult: '', remark: '', isStrikethrough: false },

  // 7. OPERASIONAL KAPAL DI LAUT
  { id: 'chk-7.1', no: '7.1', section: '7. OPERASIONAL KAPAL DI LAUT', subsection: '7. Operasional', item: 'Apakah seluruh operasional di atas kapal telah dilaksanakan sesuai dengan pedoman dan prosedur SMS Perusahaan?', ismCode: '7', defaultResult: '', remark: '', isStrikethrough: false },
  { id: 'chk-7.10', no: '7.10', section: '7. OPERASIONAL KAPAL DI LAUT', subsection: '7. Dinas Jaga', item: 'Apakah pelaksanaan dinas jaga navigasi dan kamar mesin dilaksanakan sesuai prosedur? (Jam istirahat, batas alkohol <0.05% BAC, passage planning)', ismCode: '7', defaultResult: '', remark: '', isStrikethrough: false },

  // 8. KESIAPSIAGAAN KEADAAN DARURAT (DRILLS)
  { id: 'chk-8.1', no: '8.1', section: '8. KESIAPSIAGAAN KEADAAN DARURAT (DRILLS)', subsection: '8. Latihan Darurat', item: 'Apakah kapal dalam kondisi siap menghadapi situasi darurat yang teridentifikasi dan simulasi darurat (drills) terlaksana rutin?', ismCode: '8.2', defaultResult: '', remark: '', isStrikethrough: false },

  // 9. LAPORAN & ANALISIS KETIDAKSESUAIAN (NC)
  { id: 'chk-9.1', no: '9.1', section: '9. LAPORAN & ANALISIS KETIDAKSESUAIAN (NC)', subsection: '9. Ketidaksesuaian', item: 'Apakah seluruh laporan kekurangan, ketidaksesuaian (NC), dan insiden bahaya telah ditindaklanjuti sesuai SMS Perusahaan?', ismCode: '9.1', defaultResult: '', remark: '', isStrikethrough: false },

  // 10. PEMELIHARAAN KAPAL & PERALATAN (PMS)
  { id: 'chk-10.1', no: '10.1', section: '10. PEMELIHARAAN KAPAL & PERALATAN (PMS)', subsection: '10. Pemeliharaan', item: 'Apakah kapal dan peralatannya dirawat secara memadai sesuai aturan statutori dan prosedur Planned Maintenance System (PMS) Perusahaan?', ismCode: '10.2.1', defaultResult: '', remark: '', isStrikethrough: false },

  // 11. PENDOKUMENTASIAN SISTEM (SMS)
  { id: 'chk-11.1', no: '11.1', section: '11. PENDOKUMENTASIAN SISTEM (SMS)', subsection: '11. Dokumentasi', item: 'Apakah seluruh dokumen, manual SMS, dan formulir kerja terkontrol dengan tertib dan menggunakan revisi yang sah?', ismCode: '11.1', defaultResult: '', remark: '', isStrikethrough: false },

  // 12. VERIFIKASI, TINJAUAN & EVALUASI PERUSAHAAN (INTERNAL AUDIT)
  { id: 'chk-12.1', no: '12.1', section: '12. VERIFIKASI, TINJAUAN & EVALUASI PERUSAHAAN (INTERNAL AUDIT)', subsection: '12. Audit Internal', item: 'Apakah audit internal keselamatan dilaksanakan dengan interval tidak melebihi 12 bulan sesuai ketentuan ISM Code?', ismCode: '12.1', defaultResult: '', remark: '', isStrikethrough: false },

  // TAMBAHAN BERDASARKAN TIPE KAPAL (BAGIAN A S/D E)
  // A. KAPAL TANKER MINYAK (OIL TANKER)
  { id: 'chk-add-A.1', no: 'A.1', section: 'TAMBAHAN BERDASARKAN TIPE KAPAL', subsection: 'A. Kapal Tanker Minyak (Oil Tanker)', item: 'Apakah alat ukur konsentrasi gas mudah terbakar telah dikalibrasi dengan benar?', ismCode: 'SOLAS II-2/4-5.7', defaultResult: '', remark: '', isStrikethrough: false },
  { id: 'chk-add-A.2', no: 'A.2', section: 'TAMBAHAN BERDASARKAN TIPE KAPAL', subsection: 'A. Kapal Tanker Minyak (Oil Tanker)', item: 'Apakah catatan pembuangan slop dan penutupan katup dicatat dalam Buku Catatan Minyak Bagian II?', ismCode: 'MARPOL I/31', defaultResult: '', remark: '', isStrikethrough: false },
  { id: 'chk-add-A.3', no: 'A.3', section: 'TAMBAHAN BERDASARKAN TIPE KAPAL', subsection: 'A. Kapal Tanker Minyak (Oil Tanker)', item: 'Apakah terdapat catatan operasi pencucian minyak mentah (COW) di Buku Catatan Minyak Bagian II?', ismCode: 'MARPOL I/35', defaultResult: '', remark: '', isStrikethrough: false },
  ...
  { id: 'chk-add-B.2', no: 'B.2', section: 'TAMBAHAN BERDASARKAN TIPE KAPAL', subsection: 'B. Kapal Pengangkut Gas (Gas Carrier)', item: 'Apakah awak kapal penanggung jawab muatan telah terlatih untuk penanganan aman kargo gas dan prosedur darurat?', ismCode: 'IGC Code 18.3', defaultResult: '', remark: '', isStrikethrough: false },
  ...
  { id: 'chk-add-C.1', no: 'C.1', section: 'TAMBAHAN BERDASARKAN TIPE KAPAL', subsection: 'C. Kapal Tanker Kimia (Chemical Tanker)', item: 'Apakah awak kapal yang bertugas menangani muatan kimia terlatih dengan memadai untuk penanganan bahan kimia berbahaya?', ismCode: 'IBC Code 16.3', defaultResult: '', remark: '', isStrikethrough: false },
  { id: 'chk-add-C.2', no: 'C.2', section: 'TAMBAHAN BERDASARKAN TIPE KAPAL', subsection: 'C. Kapal Tanker Kimia (Chemical Tanker)', item: 'Apakah penanganan muatan MARPOL Lampiran II dicatat dengan tertib pada Buku Catatan Kargo (Cargo Record Book)?', ismCode: 'MARPOL II/14', defaultResult: '', remark: '', isStrikethrough: false },

  // D. KAPAL CURAH (BULK CARRIER)
  { id: 'chk-add-D.1', no: 'D.1', section: 'TAMBAHAN BERDASARKAN TIPE KAPAL', subsection: 'D. Kapal Curah (Bulk Carrier)', item: 'Apakah pelatihan dan simulasi evakuasi darurat saat terjadi kebanjiran palka muat dilaksanakan sesuai prosedur?', ismCode: 'SOLAS XII/9', defaultResult: '', remark: '', isStrikethrough: false },
  { id: 'chk-add-D.2', no: 'D.2', section: 'TAMBAHAN BERDASARKAN TIPE KAPAL', subsection: 'D. Kapal Curah (Bulk Carrier)', item: 'Apakah Rencana Pemeliharaan Tutup Palka (Hatch Cover Maintenance Plan) sesuai MSC 169(79) telah tercakup dalam SMS?', ismCode: 'SOLAS XII/7.2', defaultResult: '', remark: '', isStrikethrough: false },

  // E. KAPAL CURAH BONGKAR MANDIRI (SELF-UNLOADING BULK CARRIERS)
  { id: 'chk-add-E.1', no: 'E.1', section: 'TAMBAHAN BERDASARKAN TIPE KAPAL', subsection: 'E. Kapal Curah Bongkar Mandiri (Self-Unloading)', item: 'Apakah terdapat prosedur penilaian risiko kebakaran sistem konveyor di dalam SMS? (IMSBC Code 3.1.2)', ismCode: 'IMSBC 3.1.2', defaultResult: '', remark: '', isStrikethrough: false },
  { id: 'chk-add-E.2', no: 'E.2', section: 'TAMBAHAN BERDASARKAN TIPE KAPAL', subsection: 'E. Kapal Curah Bongkar Mandiri (Self-Unloading)', item: 'Siapakah pihak yang bertanggung jawab atas penerapan penilaian risiko keselamatan kebakaran sistem konveyor bongkar muat?', ismCode: 'IMSBC 3.1.2', defaultResult: '', remark: '', isStrikethrough: false }
];

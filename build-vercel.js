...
// 4. Build standalone serverless handler bundling data.json, store, lib, and server
const dataJson = fs.readFileSync(path.join(__dirname, 'apps', 'api', 'data.json'), 'utf8');

const handlerCoreJs = `// Standalone Vercel Serverless Function for PMS Kapal REST API
...
// Clean any local .vercel/output so it doesn't conflict
